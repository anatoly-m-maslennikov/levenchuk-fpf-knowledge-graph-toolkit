...
* `EntityOfConcernSlot`,
* `ViewpointSlot`,
* `ReferenceSchemeSlot` (and usually a `RepresentationSchemeSlot` in [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]]+).
...
`CorrespondenceModel` is **used, but not defined, by [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]**: species of `U.CorrespondenceEpistemicViewing` reference it when computing views that depend on multiple epistemes or representation regimes.
...
2. Viewings and correspondence operations **must not**:
   ...
   * reinterpret EntityOfConcern without going through [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/09_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] retargeting.
...
* **Builds on [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] `U.EpistemeSlotRelation`.**
