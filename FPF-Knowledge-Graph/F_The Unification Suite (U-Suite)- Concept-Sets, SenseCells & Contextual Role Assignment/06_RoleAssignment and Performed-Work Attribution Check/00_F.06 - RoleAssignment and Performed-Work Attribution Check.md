...
**Not this pattern when.** Use [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]] for the role value, [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]] for the assignment occurrence, [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission|A.2.5]] for a current role-state predicate, [[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures|A.2.2]] for capability, and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]] for the work occurrence. Use [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/04_A.15.04 - Work-Relevant Appearance-Based Reliance Repair|A.15.4]], [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]], or another direct pattern when the current claim is evidence use, source reliance, publication, status, gate, or decision. Use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]] when "role" means a relation position rather than a work-facing `U.Role`.
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]:4.1 - Direct Relation Declaration
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]:4.2 - Obtaining and Occurrence Identity

The relation `performedUnderAssignment(W, RA)` obtains when:

1. `W` is one exact dated `U.Work` occurrence governed by [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]];
...
If the performer attribution concerns only a temporal, episode, or operational part of a larger work whole, first identify that part as the `U.Work` occurrence under [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]] and use it in `WorkOccurrenceSlot`. Do not hide an unidentified work portion inside the attribution relation.
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]:4.3 - Recover the Exact Assignment
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]:4.4 - Attribution Check Sequence
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]:4.5 - Direct Neighboring Relations

| Current question | Direct exit | Why it stays separate |
|---|---|---|
| Does the assignment obtain? | [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment]] | Assignment identity and occurrence precede work attribution. |
| Does the assignment satisfy a current state predicate? | [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission]] | Role state has its own predicate, window, assertion, and evidence use. |
| Can the holder perform the work? | [[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures]] capability and capability-fit relation | Ability is not actual performance. |
| Which method was enacted? | [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Reusable Way of Doing with Explicit Applicability]], [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing]], and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work]] | Method, method description, and work occurrence have different identities. |
| What supports the attribution assertion? | [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] or the direct evidence relation | Support concerns knowledge or use of obtaining. |
| Which encountered material is being relied upon? | [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/04_A.15.04 - Work-Relevant Appearance-Based Reliance Repair]] | Reliance on a visible item is not the attribution relation. |
| What changed, first existed, was measured or evaluated, was delivered, or was accepted in connection with the work? | [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work]] for the work, then the exact change, [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/06_A.06.01 - U.Mechanism - Reusable Law-Governed Operation Declaration]] operation-result, [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/07_A.15.PROD - Production Work, Entity-Identity Inception, and Production Completion Recovery]] inception, measurement, evaluation, delivery, or acceptance governor | None of these entities, values, or relations is a participant in performer attribution. |
| Does another vocabulary denote a corresponding role? | [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/00_F.09 - Alignment and Bridge across Contexts]] | A bridge does not mutate either local assignment. |
| Does a model-use organization change this attribution interpretation? | [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/01_A.01.01 - Bounded Model-Use Structure and DDD Bounded-Context Recovery]] plus the receiving attribution assertion or use | The receiving episteme or use may designate the selected structure; generic assignment and attribution signatures gain no optional participant. |

### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]:4.6 - Source Shorthand and `RoleEnactment`
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]:4.7 - Lightweight Use
...
Expose the relation declaration and occurrence key only when a receiving use must distinguish attribution occurrences, cite one as a participant, compare assertions, or preserve provenance. If the assignment cannot be recovered, lower the claim to "Robot-7 is named as performer in record R" and route that reliance through [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/04_A.15.04 - Work-Relevant Appearance-Based Reliance Repair|A.15.4]] or the direct source and evidence patterns.
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]:7.2 - Reviewer and Review Report

Engineer Alice is identified as the exact holder and satisfies the [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/00_A.01 - Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)|A.1]] `U.System` criterion. `ReviewAssignment-82` assigns her `ReviewerRole` under `ReviewRoles-v5` and `Review-Scheme-A` for one uninterrupted review assignment episode. `ReviewWork-82 performedUnderAssignment ReviewAssignment-82` attributes the dated work.

`ReviewReport-82` is a separately identified `U.Episteme`. When `ReviewWork-82` first constitutes that exact episteme and the inception claim matters, [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/07_A.15.PROD - Production Work, Entity-Identity Inception, and Production Completion Recovery|A.15.PROD]] recovers the local work/change/identity claim. A later evidence relation may use the report for a decision. The report never fills `HolderSystemSlot` and never becomes the attribution relation.

### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]:7.3 - Standard Used During Safety Work

A safety method description cites a standard, and source prose says that the standard has a "normative role". [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]] does not create a work-facing assignment for the standard. The standard is an episteme used through the exact external-rule, source-use, specification-use, or evidence relation selected by the claim.
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]:7.4 - Access Label and Approval Work
...
| Bridge overreach | A role word from another scheme licenses local attribution. | Recover each local assignment and use [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/00_F.09 - Alignment and Bridge across Contexts]] for correspondence. |
...
**Limits.** [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]] does not determine capability, readiness, method validity, work success, result acceptance, authorization, or evidence sufficiency. It only governs the relation by which one performed work occurrence is attributed to one role assignment.
...
|---|---|---|
| FPF [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment]], [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission]], and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work]] | Separate assignment occurrence, role-state relation, and dated work occurrence. | Adopt directly: `performedUnderAssignment` relates exact work and assignment occurrences without importing state or evidence as participants. |
...
**Builds on:** [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.REL - Relation Obtaining and Individuated Relation Occurrences|A.6.REL]] for relation obtaining and occurrence identity; [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]] for `U.Role`; [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]] for `U.RoleAssignment`; and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]] for dated `U.Work`.

**Uses when current:** [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission|A.2.5]] for role state; [[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures|A.2.2]] for capability; [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Reusable Way of Doing with Explicit Applicability|A.3.1]], [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/00_A.15 - Role-Method-Work Alignment|A.15]] for method and work alignment; [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence; [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/04_A.15.04 - Work-Relevant Appearance-Based Reliance Repair|A.15.4]] for reliance on encountered project material; [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/00_F.09 - Alignment and Bridge across Contexts|F.9]] for cross-scheme correspondence; and [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/01_A.01.01 - Bounded Model-Use Structure and DDD Bounded-Context Recovery|A.1.1]] only when an independently selected model-use structure changes assignment interpretation.

**Coordinates with:** [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/04_Role Description - Description Episteme for U.Role/00_F.04 - Role Description - Description Episteme for U.Role|F.4]] for role-description epistemes; [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/05_Naming Discipline for U-kind Names and RoleDescription Labels/00_F.05 - Naming Discipline for U-kind Names and RoleDescription Labels|F.5]] and [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]] for durable names; [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] for publication; and [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF|E.10]] for source-word precision repair.

## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]:15 - Completion Conditions

[[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]] use is complete when the reader has either:
