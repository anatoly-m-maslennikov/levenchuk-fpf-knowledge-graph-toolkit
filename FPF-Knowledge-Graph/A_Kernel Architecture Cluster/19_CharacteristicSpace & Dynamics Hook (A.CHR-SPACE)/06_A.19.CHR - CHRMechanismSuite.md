...
**Pattern class:** specialization of **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]** (`MechSuiteDescription`) for the CHR (characterization) core.
...
* [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]] `MechSuiteDescription` (Kernel)
* [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/03_A.15.03 - SlotFillingsPlanItem|A.15.3]] `SlotFillingsPlanItem` (WorkPlanning)
* [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/06_A.06.01 - U.Mechanism - Reusable Law-Governed Operation Declaration|A.6.1]] `U.Mechanism.Intension` (mechanism norm-form)
* [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]] slot discipline (`SlotSpec := ⟨SlotKind, ValueKind, refMode⟩`; `SlotIndex` is a projection)
...
* **Planned baseline binding (instances/editions/policy pins):** [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/03_A.15.03 - SlotFillingsPlanItem|A.15.3]] + `A.19.CHR:4.7.2` (refs/pins only; no launch values).
...
**Required fields (minimum; aligns with [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/03_A.15.03 - SlotFillingsPlanItem|A.15.3]] naming)**
...
* MUST include explicit context anchors:
  ...
  * `bounded_context_ref`,
  * `cg_frame_ref`,
  * `reference_plane` (unless unambiguously derivable from the cited bounded-context reference and related context records; see [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/03_A.15.03 - SlotFillingsPlanItem|A.15.3]] context-derivability rule),
  * `path_slice_id`,
...
Edition pins MAY be carried via edition-addressable refs in `planned_fillings` and/or via per-row `SlotFillingRow.edition_pin` ([[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/03_A.15.03 - SlotFillingsPlanItem|A.15.3]] edition-pin rule); they MUST remain pins and anchors, not copied content.
...
* **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]] `MechSuiteDescription`** (the base suite description kind and obligations surface)
* **[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/03_A.15.03 - SlotFillingsPlanItem|A.15.3]] `SlotFillingsPlanItem`** (planned baseline in WorkPlanning)
* **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/06_A.06.01 - U.Mechanism - Reusable Law-Governed Operation Declaration|A.6.1]] `U.Mechanism.Intension`** and **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]] slot discipline** (SlotSpecs in signatures; SlotIndex as projection)
