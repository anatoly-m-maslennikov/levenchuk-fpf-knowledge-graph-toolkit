...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:0.1 - Terminology: “binding” is overloaded (normative)
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:1 - Problem frame
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:2 - Problem
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:3 - Forces
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:4 - Solution
...
* how it is used as the canonical payload for **D-quadrant** obligation, recommendation-as-duty, and prohibition claims ([[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]), while permission claims route to the exact [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/01_A.02.08.PER - Granted Permission, Exercise, and Non-Prohibition|A.2.8.PER]] result,
* and what must be stated for a commitment to be considered **auditable**.

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:4.1 - Normative definition
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:4.2 - Minimal structure (normative)
...
DeonticModalityToken ::=
  ...
  // MAY and OPTIONAL do not normalize into U.Commitment. Recover their actual claim: strong or weak permission under [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/01_A.02.08.PER - Granted Permission, Exercise, and Non-Prohibition|A.2.8.PER]], an A-* entry predicate, or informative prose.
...
SpeechActRef ::=
  ObjectIdRef
  // MUST resolve to a `U.SpeechAct` Work occurrence ([[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Kind, Occurrences, and Records)|A.2.9]]).
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:4.3 - Interaction rules (normative)
...
5. **Commitment changes are explicit (no silent mutation).**
   When a commitment is updated, narrowed, broadened, superseded, or revoked, the change **SHOULD** be represented as a new `U.Commitment` (new ID) and an instituting `U.SpeechAct` ([[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Kind, Occurrences, and Records)|A.2.9]]) that references the affected commitment IDs (e.g., via `U.Commitment.source.speechActRef` and a status/supersession claim), rather than editing a published commitment in place without an auditable change record.

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:4.4 - Canonical use in boundary claim registers (recommended)

When using the [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/00_A.06 - Signature Stack & Boundary Discipline|A.6]] stack, represent each **D-quadrant** atomic claim that states an accountable obligation, recommendation-as-duty, or prohibition as a `U.Commitment` payload with the fields below. A `D-*` strong/weak permission, exercise, non-violation, or conflict claim instead cites the exact [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/01_A.02.08.PER - Granted Permission, Exercise, and Non-Prohibition|A.2.8.PER]] result and does not acquire a `U.Commitment` payload:
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:5 - Archetypal Grounding (Tell–Show–Show)

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:5.1 - Tell (universal rule)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:5.2 - Show #1 (system archetype: incident response SLO discipline, post‑2015 SRE practice)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:5.3 - Show #2 (episteme archetype: protocol specification with behavioural typing motif)
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:6 - Bias-Annotation
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:7 - Conformance Checklist (normative)
...
2. **CC‑[[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]‑2 (Explicit modality).** A normative `U.Commitment` **MUST** specify `modality` as `DeonticModalityToken` (with any RFC-keyword synonyms normalized to it).
...
4. **CC‑[[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]‑4 (Referents present and by ID).** `referents` **MUST** be non‑empty. If the bound content exists as claim IDs, the commitment **SHOULD** reference those IDs in `referents` rather than restating their content.
...
6. **CC‑[[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]‑6 (Evidence separation).** If an `E-*` claim is referenced only for measurement/verification, it **SHALL** appear in `adjudication.evidenceRefs` (not in `referents`).

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:9 - Consequences
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:10 - Rationale
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:11 - SoTA-Echoing (informative; post‑2015 alignment)
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:12 - Relations

**Uses / builds on**

* [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]] for identifying accountable roles vs role-enactors (role assignments).
...
* [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] (Quadrant D) as the canonical payload shape only for obligation, recommendation-as-duty, and prohibition statements; strong or weak permission, exercise, non-violation, and conflict claims cite the exact [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/01_A.02.08.PER - Granted Permission, Exercise, and Non-Prohibition|A.2.8.PER]] result instead.
...
* **[[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Kind, Occurrences, and Records)|A.2.9]] (`U.SpeechAct`)**: `U.Commitment.source.speechActRef` points to the instituting communicative work occurrence when provenance matters.
* [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]] (`U.Work`) and evidence patterns: adjudication hooks refer to evidence in work, not to text.
* **[[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/01_A.02.08.PER - Granted Permission, Exercise, and Non-Prohibition|A.2.8.PER]]:** strong grants, permission exercise, weak non-prohibition/non-violation findings, and permission conflicts remain separate from `U.Commitment`; a visible `MAY` or `OPTIONAL` token does not choose between those objects and an `A-*` entry predicate.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_U.Commitment (Deontic Commitment Object)/00_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]:End
