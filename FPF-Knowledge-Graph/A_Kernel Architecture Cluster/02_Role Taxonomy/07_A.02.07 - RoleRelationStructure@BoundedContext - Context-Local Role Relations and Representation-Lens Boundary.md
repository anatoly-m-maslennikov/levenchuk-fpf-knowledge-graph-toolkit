...
- If the current claim is who holds a role, use [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]].
...
- method or work decomposition under [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/00_A.15 - Role-Method-Work Alignment|A.15]] when the source actually divides method into submethods or work into work-part relations.
...
| `CC-A2.7-08` | Do assignment and state checks use [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment]] and [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission]]? |
| `CC-A2.7-09` | Do method claims use [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/00_A.03 - Transformer Constitution (Quartet)]] patterns and work claims use [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/00_A.15 - Role-Method-Work Alignment]] patterns? |
...
| Pattern | Relation |
|---|---|
| [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/01_A.01.01 - Bounded Model-Use Structure and DDD Bounded-Context Recovery]] | Supplies `U.BoundedContext`, the locality boundary for role relation structure. |
...
| [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment]] | Governs `U.RoleAssignment`, the relation checked when role-admission substitutions, incompatibilities, or bundles are used for real holders. |
...
| [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Reusable Way of Doing with Explicit Applicability]], [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/00_A.15 - Role-Method-Work Alignment]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/02_A.15.02 - U.WorkPlan]] | Govern method, method description, plan, and performed work uses that may cite a role relation. |
| [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline]] | Supplies relation-slot discipline for role-relation declarations and use relations. |
| [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/12_A.06.RSIR - Relation, Signature, Interface, Role, and Slot Precision Restoration]] | Recovers role, slot, relation, signature, and interface source wording before role-relation repair when the source sentence is mixed. |
