...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:0 - Use this when
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:1 - Problem frame
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:2 - Problem
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:3 - Forces
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:4 - Solution

### [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:4.1 - Recover the exact conflict
...
3. Recover the exact FPF claim epistemes, dated application-work occurrences, direct kinds and relations, [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/03_A.07.CP - Constructive-Premise Compact and Reasoning-Basis Use|A.7.CP]] reasoning-basis occurrences, source-use occurrences, scope, and currentness.
...
### [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:4.2 - Use one closed reconciliation result set
...
### [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:4.3 - Record claim-relative source use
...
```
The source participant is the exact source episteme and edition consumed. The receiving participant is the exact ontology-claim episteme and edition being formulated, constrained, tested, interpreted, compared, or traced. The work participant is the dated ontology-decision `U.Work`: its already admitted holder `U.System` performs that work under an exact current `U.RoleAssignment`. When an [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]] `performedBy(W, RA)` attribution is cited, `RA.HolderSystemSlot` must resolve to that same system; the assignment neither supplies the system nor performs the work.
...
### [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:4.4 - Identify source-use conflict without ranking traditions
...
### [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:4.5 - Stop and reopen
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:5 - Archetypal Grounding
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:6 - Bias-Annotation
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:7 - Conformance Checklist
...
| `CC-A7.2-4` | Every load-bearing common claim is cited from [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/03_A.07.CP - Constructive-Premise Compact and Reasoning-Basis Use]] through an actual reasoning-basis occurrence. |
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Copy the common compact into this method. | Cite exact `A7CP-*` claims; leave claim content and relation ownership in [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/03_A.07.CP - Constructive-Premise Compact and Reasoning-Basis Use]]. |

## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:9 - Consequences
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:10 - Rationale
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:11 - SoTA-Echoing
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:12 - Relations

- **Coordinates with:** [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/01_A.07.01 - Consequence-Guided Ontological Problem Solving|A.7.1]]. [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]] is neither its parent nor child; it handles material cross-pattern premise conflict and can return repaired direct-owner decisions to it.
- **Consumes:** exact claim contents from [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/03_A.07.CP - Constructive-Premise Compact and Reasoning-Basis Use|A.7.CP]] through actual `ClaimUsedAsReasoningBasisRelation@Context` occurrences; it does not copy or own the compact. Pattern and method epistemes supply clauses or declared premises, while dated application work and its result claims supply the reconciliation inputs.
...
- **Coordinates with:** [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence use, [[G_Discipline SoTA Patterns Kit/12_11_Telemetry-Driven Refresh and Decay Orchestrator/00_G.11 - Telemetry-Driven Refresh and Decay Orchestrator|G.11]] for currentness, [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] and direct formal patterns for formal semantics, [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]]/[[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] for source epistemes and publications, and subject patterns for the receiving ontology claim.
- **Preserves:** current landed FPF decisions as default internal basis while allowing grounded, claim-specific reopen. It does not replace [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] review or DRR discharge.
...
## [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/02_A.07.02 - FPF Ontology-Premise Reconciliation|A.7.2]]:End
