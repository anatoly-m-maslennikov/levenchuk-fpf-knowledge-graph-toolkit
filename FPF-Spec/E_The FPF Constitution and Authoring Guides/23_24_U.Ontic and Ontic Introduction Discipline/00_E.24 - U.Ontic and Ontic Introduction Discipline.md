...
| Force | Tension |
| --- | --- |
| Ontic stability vs bounded local explanation | A durable FPF ontic needs stable identity plus named direct relation kinds and their governing rules; a bounded local episteme keeps its [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations]] identity and needs only the claims and references required for one application family. |
...
| Ontology governance vs pattern placement | The primary governed subject kind, exact identity or constitution rule, minimal governed relation set, and their governing patterns determine the ontic-introduction decision; a pattern nest is only publication and specialization placement under [[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide]]. |
...
| Naming vs ontology | [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol]] can improve a name, but naming cannot decide identity, direct relations, declarations, species, or the reliance basis of dependent patterns. |
...
Keep the subject under decision separate from every means of stating, presenting, or inspecting it. Open a neighboring row in `E.24:4.3a` only when that object's identity or direct relation changes the current choice or receiving use. A decision or description remains a [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] episteme; availability, viewpoint conformance, and mathematical correspondence do not alter the subject's identity.
...
U-kind admission is a neighboring E.24-family question, not the main body of [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]]. Both hosts use the one `E24FamilySettlementDecision` schema in `E.24:4.0a`:
...
Use [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Admission and Ontic Settlement|E.24.UK]] only when a candidate claims durable U-kind force. [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] consumes its exact accepted result when that result changes the ontic settlement; naming or placement alone supplies neither output.
...
If a reader asks where an FPF ontic gets constructive grounding, follow the identity or grounding rule named by its direct owner. [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] records that rule and only the relations needed by dependent use; it does not turn declarations, descriptions, publication objects, views, or representations into grounding participants. Their owners remain in `E.24:4.3a`.

For structural identity claims, the constructive chain is `E.14 -> [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/03_B.03.05 - Working-Model Relations & Grounding (CT2R-LOG)|B.3.5]] -> C.13`: Working-Model relation first, declared `validationMode`, `tv:groundedBy`, and a reconstructible `Γ_m.sum`, `Γ_m.set`, or `Γ_m.slice` trace. The `Γ_m` trace is the reconstructible grounding object cited through `tv:groundedBy` under [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/03_B.03.05 - Working-Model Relations & Grounding (CT2R-LOG)|B.3.5]]. If a graph, tuple, or another mathematical expression represents that trace, the expression is a separate [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] representation. Neither the trace nor its representation becomes the public relation vocabulary, and this structural grounding apparatus is not required for non-structural ontics.

For a non-structural ontic, use the identity, grounding, or recognition rule named by its direct subject pattern. Open [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Admission and Ontic Settlement|E.24.UK]] only for U-kind admission, [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] only for an episteme's identity, [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]] only for current availability, and the other rows of `E.24:4.3a` only when their selection question is true.
...
The bootstrap co-decision is `E24-CO-UONTIC-BOOT-01`. Its EntityOfConcern is the exact source-construct entity defined by [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]]:4 for the kind `U.Ontic`; it does not presuppose an admitted `U.Ontic` or a pre-existing ontic instance. From that common input it returns two distinct accepted outputs: `E24-OS-UONTIC-BOOT-01`, which accepts this shared settlement schema as the direct rule for identifying future ontology-unit individuals, and `E24UK-AR-UONTIC-BOOT-01`, which admits the root kind `U.Ontic`. The schema, pattern, decision episteme, and kind are not thereby instances of `U.Ontic`; each concrete ontology-unit individual still needs an ordinary `OnticSettlementResult`. No relation-about-relation or relation from the kind to itself is invented for the bootstrap.

[[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] is compatible with modular ontology and ontology-design-pattern practice: modular ontology libraries and ontology design patterns show why reusable small ontology structures matter, and recent process-modeling work reports loss of reuse when process patterns remain implicit. [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] is narrower and more FPF-specific: it governs the decision whether FPF should introduce a durable action-facing ontic, rather than importing an external microtheory or treating every reusable repair table as ontology.

If the three resolved ontology dispositions need reusable comparison, apply [[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]] to construct the evaluation `CharacteristicSpace`: retain the current governing-pattern relations, add one bounded local episteme whose claims cite them for a declared use, or add a durable ontic and its governing pattern. [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] supplies those candidate dispositions and the ontic constraints applicable to each; [[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]] owns characteristic selection and evaluation. Source-use status remains an independent provenance choice and is not a fourth candidate. A comparison result does not establish ontic identity.

Within this split, [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] carries the distinction among the ontic, the claim-bearing decision episteme, reusable declarations, and publication-side objects, plus the ontic-introduction decision needed before dependent patterns rely on a durable ontic. Publication-section rules, adequacy scales, wording-use restoration rules, and evaluation of the resulting FPF pattern-set structures are handled by the neighboring patterns named above.

Use the current split this way:

- use [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] for `U.Ontic` identity, the primary governed subject kind, exact identity or constitution rule, minimal governed relation set, governing patterns, named dependent-pattern reliance, and non-use boundary;
- use [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/01_E.24.CD - Ontic Candidate Detection and First-Use Disposition|E.24.CD]] when the current problem is detecting and characterizing an apparent subject before deciding whether it should enter an [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] ontic-introduction decision at all; [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/01_E.24.CD - Ontic Candidate Detection and First-Use Disposition|E.24.CD]] supplies detection and characterization only and selects no [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] disposition. `Local use frame` is not an [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] disposition: recover whether the payload needs direct governing-pattern use, a bounded local episteme under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]], a durable ontic, or an unresolved stop; record any source-use status separately.
- use [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]] when the current problem is the distinction among the ontic, an ontic-description episteme, the publication occurrence that makes one selected edition available, the publication form that expresses it for that use, and the `U.PresentationCarrier` that bears the form; use [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] for `U.View` membership, [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] for optional viewing construction, and [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] for a representation;
- use [[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]] only when the contested question is how to construct an evaluation `CharacteristicSpace` for comparing the resulting FPF pattern-set structures after retaining the governing-pattern relations, adding one bounded local episteme whose claims cite them for a declared use, or adding a durable ontic and its governing pattern.

This split keeps [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] ontic-first. Questions about candidate detection, publication discipline, and contested evaluation remain under their neighboring governing patterns rather than becoming sections that turn [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] into a general discovery, documentation, or scoring pattern.
...
Use direct governing patterns first. If the case is method semantics, use [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Reusable Way of Doing with Explicit Applicability|A.3.1]]; if it is method description, use [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]; if it is mechanism meaning, use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/06_A.06.01 - U.Mechanism - Reusable Law-Governed Operation Declaration|A.6.1]] and [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]; if it is work planning or dated work, use [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/02_A.15.02 - U.WorkPlan|A.15.2]] or [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]]. For evidence, gate, source, assurance, decision, release, publication, or another case, name the current claim and its current direct governing pattern by exact pattern ID before selecting direct governing-pattern use. If no current governor can be recovered by value, that disposition is unavailable; return to the other [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] dispositions rather than treating the topic word as authority.
...
If those questions cannot be answered, keep any needed coordination in a bounded local episteme under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] or use the direct governing patterns without another coordination episteme.
...
| --- | --- | --- |
| Holon or System | [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/00_A.01 - Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)]]'s exact candidate, constituents, constructive part relations and assembly, reidentification, whole-level characteristic, larger-assembly compatibility, and any kind-specific condition | keep those facts under their direct owners; [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/00_A.01 - Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)]] explicitly forbids compressing them into one universal relation signature |
| Method | [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Reusable Way of Doing with Explicit Applicability]]'s semantic way-of-doing identity and any independently governed method-holarchy facts | name only the direct relations needed by dependent method use; no head relation is presumed |
| Work | [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work]]'s dated occurrence identity and continuity rule | performer, enacted method, affected referent, resources, and results stay under their exact direct relations or [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/06_A.06.01 - U.Mechanism - Reusable Law-Governed Operation Declaration]] bindings |
| Transformation | [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/04_U.Transformation- Bounded Change Under Conditions/00_A.03.04 - U.Transformation- Bounded Change Under Conditions]]'s independently identified actual bounded change at the selected resolution | work, flow, production, representation, and receiving-use relations remain separate; no core relation is invented |
| Episteme | [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations]]'s constitution rule | `EpistemeConstitutionRelation` is identity-bearing because [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations]] explicitly selects it; empirical grounding, edition, conformance, and publication remain neighboring relations |
| Relation | [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.REL - Relation Obtaining and Individuated Relation Occurrences]] plus each direct relation pattern's obtaining and occurrence-identity rule | the ontology unit coordinates common occurrence discipline with those direct rules; no relation-to-relation head occurrence is required |

### [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]]:4.3 - Check 3: Direct Relation and Declaration Test
...
- **A bounded local episteme is needed** when one named receiving use must read several already governed claims together, but no other current pattern relies on their package as reusable ontology. Identify that one episteme under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] and keep every governed object under its direct pattern.
...
Treat a filled card as the decision episteme only when its claim content, exact `decisionEntityOfConcern`, and effective ReferenceScheme are recoverable under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]]. A working phrase, topic cluster, draft heading, or list is not that exact subject. If neither a governed object nor an exact source episteme or expression entity is recoverable, the card remains an inquiry prompt.
...
OnticIntroductionFirstUse:
  ...
  ontologyDisposition: fill last from those results: direct governing-pattern use | bounded local episteme under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] | durable ontic | unresolved stop.
...
#### [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]]:4.3a - Authoritative Typed Object Map
...
| Reusable declaration | Does another use need the same participant typing without asserting an occurrence? | `RelationSignature` episteme and only the reused `SlotSpec = <SlotKind, ValueKind, refMode>` declarations under [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline]] |
| Claim-bearing episteme | Does the receiving use need an assertion, description, decision, or several governed claims read together? | [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations]] identity, exact EntityOfConcern, ClaimGraph, effective ReferenceScheme, declared use, and stop; a bounded episteme governs no new ontology |
| Durable ontology unit | Must multiple current patterns reuse one independently identified unit or otherwise duplicate or disagree about identity, constitution, or the minimal relation set? | ontology-unit individual, primary subject kind, identity or constitution rule, minimal relation set and governors, governing ontic pattern, [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Admission and Ontic Settlement]] result when current, and dependent reliance |
| Publication object | Is availability of one selected episteme edition to an audience current? | under [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline]].PUB/E.17, distinguish the publication occurrence, selected edition, audience and use, form that expresses it, and carrier that bears the form |
| View | Does one identified episteme conform to an exact viewpoint for the receiving use? | [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences]] conformance for the same episteme as `U.View`; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism]] construction only when that history is current; viewpoint use does not change episteme identity |
| Representation | Does a declared modeling or reasoning use need an explicit correspondence? | [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use]] representation, its elements, effective representation scheme, and explicit correspondence to an independently identified object; representation does not change that object's identity |
...
OnticIntroductionDecisionReplay:
  ...
  onticRootIfSelected: `EpistemeOntic`, one explicitly designated ontology-unit individual of kind `U.Ontic`. [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] reidentifies it from the primary governed subject kind `U.Episteme` and the identity-bearing direct relation kind `EpistemeConstitutionRelation`, including that relation's predicate, participant meanings, and admitted actual-participant kinds. It is neither the `U.Episteme` kind nor any PumpStation37 episteme.
  identityBearingDirectRelationIfSelected: `EpistemeConstitutionRelation`, governed by [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]]. Its participant meanings are constitutive claim content, exact EntityOfConcern, and effective reference scheme; its admitted actual-participant kinds are `U.ClaimGraph`, `U.Entity`, and `U.ReferenceScheme`. It obtains when the scheme makes the claim graph interpretable and evaluable as claims about the exact entity and the three participants form one claim-bearing whole; the participant triple identifies the occurrence. The PumpStation37 consuming witness is the distinct occurrence among `MaintenanceClaims_v7`, `PumpStation37`, and `StationMaintenanceReferenceScheme_2026`; that project occurrence neither is nor identifies `EpistemeOntic`.
  reusableDeclarationsIfNeeded: `EpistemeConstitutionRelationSignature` with the three SlotSpecs declared in [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]], only where another pattern needs reusable participant typing.
  minimalGovernedRelationSet:
    instanceLayer: `EpistemeConstitutionRelation` among actual claim graph, EntityOfConcern, and reference scheme is identity-bearing; `EpistemeEmpiricalGroundingRelation`, `EpistemeEditionRelation`, `EpistemeViewpointConformanceRelation`, and `EpistemePublicationRelation` retain the actual participants and predicates supplied by [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]], [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], and [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]] when their named use is current. [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] construction and [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence use remain separate and join only under their own current governors.
  ...
  claimBearingEpistemesIfNeeded: this decision is identified under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] by `PumpMaintenanceOnticDecisionClaims_v1` as its ClaimGraph, exact `EpistemeOntic` as its EntityOfConcern, and `FPF-Ontic-Decision-Scheme-2026` as its effective ReferenceScheme. The PumpStation37 episteme and its constitution occurrence are separate consuming witnesses; a separate assertion about that occurrence is added only when that claim is current.
  viewIfNeeded: exact maintenance episteme E is the same individual as a `U.View` only when [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] conformance to exact maintenance viewpoint P obtains; any source episteme and [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] construction remain separate.
  representationIfNeeded: a wiring-diagram representation remains under [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] and corresponds to independently recovered objects.
  ...
  dependentPatterns: [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] relies on the same [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] episteme identity plus exact viewpoint conformance when the specification is admitted as a `U.View`; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] relies on the independently identified source and receiving epistemes only when viewing construction is current. Neither pattern copies the constitution rule.
...
For ordinary first use, stop at the one-screen card unless dependent patterns will rely on the proposed ontic, the current claim changes admissible use, or a receiving use needs a replayable reason why a bounded local episteme under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] was not enough.
...
OnticIntroductionDecision:
  OntologyDisposition: fill last from the existing-governor, identity, connectivity-or-constitution, dependent-use, and non-duplication evidence; durable ontic | bounded local episteme under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] | direct governing-pattern use | unresolved stop.
  ...
  E24FamilySettlement:
    DecisionMode: ontic-only | U-kind-only | atomic ontic-plus-U-kind.
    SharedCandidateInputsRef: exact CandidateInputs block governed by [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]]:4.0a.
  ...
  UKindDecisionIfCurrent:
    E24UKDecisionRef: exact [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Admission and Ontic Settlement|E.24.UK]] `UKindAdmissionDecision` episteme.
    ...
    AdmissionDisposition: exactly one value from [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Admission and Ontic Settlement|E.24.UK]]'s closed set: root | same-individual-dependent | identity-dependent | reuse | local-kind | reject.
    BranchDetailRefIfRequired: the exact branch-specific reference or references required by [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Admission and Ontic Settlement|E.24.UK]] for that disposition.
...
For every other candidate, complete the decision form by value; no candidate inherits the `U.*` decision from [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]].

When typed reuse needs a declaration of one selected direct relation, its `RelationSignature` uses [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]] and the [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] decision defines no second slot discipline; the direct relation itself remains governed by its direct pattern. A SlotKind names one participant meaning only inside the selected `RelationSignature`, and its ValueKind constrains the admitted kind of the actual participant corresponding to that SlotSpec. Neither the SlotKind label nor its wording decides that kind; the participant's direct governing pattern does.

### [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]]:4.4 - Check 4: Governing-Pattern and Dependent-Use Test
...
Naming, publication placement, and evaluation remain neighboring authoring work under [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]], [[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide|E.8]], [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]], and [[E_The FPF Constitution and Authoring Guides/20_21_FPF Pattern-Quality Evaluation CharacteristicSpace/00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]]. The ontic-introduction decision may point to those next moves, but none establishes ontic identity or replaces the governing pattern.

If the decision selects a durable ontic, write the pattern that governs it before dependent patterns rely on it. If the decision selects only a bounded local episteme, identify that episteme under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] and state its non-governing bounded use and claims by value. If no pattern governing the proposed durable ontic is written, do not cite that candidate as governing current FPF use.

### [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]]:4.5 - Bounded Local Episteme Decision
...
**Positive example.** `Pump37MaintenanceCoordination_v1` has exact Pump #37 as its EntityOfConcern. Its ClaimGraph may designate the current maintenance plan, dated work, enacted method, and direct relations because every claim explains how this exact pump is maintained for the named scheduling decision. Pump #37's [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/00_A.01 - Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)|A.1]] identity is independent of the coordinating episteme.
...
### [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]]:5.1 - Episteme Ontology Unit as Durable Ontic

The ontology-unit individual `EpistemeOntic` passes because multiple patterns reuse [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] episteme identity and its exact direct relation rules without copying them. [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Admission and Ontic Settlement|E.24.UK]] retains `U.Episteme` as the root kind, [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] identifies each particular episteme, and neither is `EpistemeOntic`. The PumpStation37 specification is a consuming witness. Descriptions, availability, views, and representations use their rows in `E.24:4.3a` and do not change that identity.
...
A source-driven use closes only after the exact expression remains linked to what was carried forward. For example, a source expression `workflow` may have source-use status `quote-only` while its ontology disposition is direct governing-pattern use of one recovered `U.MethodDescription` under [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]] and one selected `TransformationFlowStructure` under [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]]. The source expression neither becomes their common kind nor disappears from the provenance of that use. If a later claim needs the source's stronger ordering, execution, or evidence meaning, reopen the named source episteme and apply the exact direct governing pattern for that stronger claim.

### [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]]:5.2a - One Workflow Expression Across the Boundary

Use one fixture to see what changes the answer. The exact expression `Line 7 pump-service workflow` comes from source episteme `Line7MaintenanceManual_v4`; when availability matters, `Line7ManualRelease_2026-04` is its source publication occurrence. Keep its source-use status `quote-only` in every case below. The recovered objects are already governed: `Pump37ServiceMethodDescription_v2` under [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], `Pump37WeeklyMaintenancePlan_2026Q3` under [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/02_A.15.02 - U.WorkPlan|A.15.2]], dated Work occurrence `Pump37ServiceWork_2026-07-18` under [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]], and selected `Pump37MaintenanceFlowStructure` under [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]]. The expression and provenance do not choose the ontology disposition; the receiving use and recovered subject do.

1. **Direct-use result.** A manual editor needs to check the one claim that `Pump37ServiceMethodDescription_v2` describes the service method used in the manual. The exact EntityOfConcern is that identified method-description episteme, and [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]] closes the readable claim. Select direct governing-pattern use. Do not add a coordination episteme or a workflow ontic.
2. **Bounded-episteme result.** A weekly scheduling review needs the method description, current work plan, dated Work occurrence, and selected flow structure read together because each claim explains how exact Pump #37 will be serviced that week. Exact Pump #37 is the EntityOfConcern of `Pump37WorkflowScheduling_v1`, identified under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]]. No current pattern consumes that claim package as ontology. Select bounded local episteme; leave every designated object under its direct governor.
3. **Durable-ontic threshold—not met by the current fixture.** A durable result would require multiple current patterns to consume one same independently identified ontology unit and otherwise duplicate or disagree about its identity or constitution and minimal relation set. Before selecting that branch, a direct subject owner would have to identify a candidate such as `MaintenanceWorkflowOntic_v1`, supply its stable identity or constitution rule, and show exactly how the current [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/02_A.15.02 - U.WorkPlan|A.15.2]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]], and [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] consumers rely on that one unit rather than merely mentioning their distinct governed objects. Until that stronger owner and cross-pattern reliance exist, the source expression and recurring four-object list do not identify a durable ontic.
...
Dependent subject patterns may keep a thin cue: when one recognizable concern spans several direct entities and relations, name the relation currently being asserted and use its governing pattern. That cue does not license treating a local set of references as a durable ontic before the [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] decision, assigning one entity to two kinds without direct admission, or treating a SlotKind label as alternate ontology.

### [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]]:5.3 - Draft ToC Row or Planned Pattern Label as False Authority
...
| `CC-E24-5c` | Mathematical operands, tuple components, nodes, and edges remain [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use]] representation elements. A correspondence to a relation object neither identifies the two nor contributes to world-side occurrence identity. |
...
| `CC-E24-8a` | Durable `U.*` names, reusable SlotKind heads, dependent-kind names, publication-form names, public ids, Core-facing heads, and cross-context labels use [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol]]; `F.17 UTS` and Name Card material is opened only when that name becomes public, Core-facing, or cross-context, and never replaces [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline]] SlotSpec discipline. |
| `CC-E24-8b` | A `U.*` spelling, type or kind wording, structural heading, title, filename, or ToC row that claims U-kind force is governed by [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Admission and Ontic Settlement]] before naming patterns are asked to choose or keep a public term. |
...
| --- | --- | --- |
| Shadow-kind by repetition | The same claim-bearing episteme or reusable publication form appears in several patterns and starts being cited as an ontology object. | Apply [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline]]; either write a durable ontic pattern or keep the coordination in a bounded local episteme under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations]]. |
...
| Slot list without identity | A pattern lists record fields as if they were SlotSpecs but never states what identifies the proposed ontic. | Add the exact identity or constitution rule and the smallest direct-relation set required by named dependent use, or keep the claims and references in a bounded local episteme under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations]] without proposing a durable ontic. |
| Pattern nest as ontology | A numbering or placement group is treated as the governed subject. | Name the primary governed subject kind, exact identity or constitution rule, minimal governed relation set, and their governing patterns; keep the pattern nest as publication and specialization placement under [[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide]]. |
...
- **Builds on:** [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.REL - Relation Obtaining and Individuated Relation Occurrences|A.6.REL]] for direct relation occurrence identity, each direct relation pattern for relation-participant meanings, obtaining, applicability, and occurrence identity, and [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.RCD - Needed Relation Claim Derivation and Relation-Kind Admission|A.6.RCD]] for a residual needed claim or a derived-or-primitive candidate with its proposed direct subject settlement; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.00 - U.Signature - Reusable Law-Governed Declaration Episteme|A.6.0]] and [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]] govern reusable `RelationSignature` and `SlotSpec` declarations, and [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] governs decision, assertion, predicate-definition, and description epistemes.
- **Coordinates with:** [[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide|E.8]] for pattern publication placement, [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF|E.10]] and [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/02_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] for wording-use restoration, and [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]] for durable naming after ontology is settled.
- **Coordinates with:** [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/01_E.24.CD - Ontic Candidate Detection and First-Use Disposition|E.24.CD]] for candidate detection before the ontic-introduction decision, [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Admission and Ontic Settlement|E.24.UK]] for the `UKindAdmissionResult` output of the one shared `E24FamilySettlementDecision`, and [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]] for ontic-description and publication distinctions. When both a new ontic and a new public U-kind are needed, [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] and [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Admission and Ontic Settlement|E.24.UK]] consume the same atomic decision inputs and neither treats the other's output as prior evidence.
- **Coordinates with:** [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] for `U.View` membership, [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] for optional viewing construction, [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] for mathematical representation, and the `E.14 -> [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/03_B.03.05 - Working-Model Relations & Grounding (CT2R-LOG)|B.3.5]] -> C.13` chain for structural constructive grounding. Each ontic-introduction decision names any additional subject-specific governing patterns instead of treating this relation list as a registry.
- **Coordinates with:** [[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]] for contested comparison of candidate dispositions, [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]] and [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] for recording and evaluating the authoring decision, and [[E_The FPF Constitution and Authoring Guides/20_21_FPF Pattern-Quality Evaluation CharacteristicSpace/00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] for evaluating the resulting pattern. Those evaluation results do not become part of the selected ontic.
