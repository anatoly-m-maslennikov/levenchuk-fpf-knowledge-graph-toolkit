...
* ecological affordance discourse, including source-tradition `affordance` cases that must leave quality-term restoration for [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/13_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] or another action-invitation governing pattern?
...
* A statement about **what a system does** uses [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] first when function-like wording hides the FPF kind named by value, relation, or claim, then the pattern governing the recovered capability, method, work, role, [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/15_A.06.M - Module Relation Repair|A.6.M]] module-interface, architecture, mathematical, evidence, assurance, gate, decision, or release claim whose primary `EntityOfConcern`, bearer, relation record, or characteristic-space construction is recovered.
...
A conforming quality-term repair publication SHALL narrate changes with a stable change lexicon aligned to [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/10_P_Relational Precision Restoration - Recovering Direct Relations from Under-Specified Claims/00_A.06.P - Relational Precision Restoration - Recovering Direct Relations from Under-Specified Claims|A.6.P]]:
...
* [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/00_C.02.P - Epistemic Precision Restoration|C.2.P]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]], or bridge-policy vocabulary changes the admissible lane, EntityOfConcern, publication-face, carrier, or `ReferencePlane` wording used by this pattern;
