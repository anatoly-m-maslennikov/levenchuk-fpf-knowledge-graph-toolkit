...
**Depends on.** A‑kernel ([[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/00_A.01 - Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)|A.1]]–[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/00_A.15 - Role-Method-Work Alignment|A.15]]), **A.17/A.18/A.19** characteristic-space discipline, **MM‑CHR** measurement infrastructure ([[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]]), **KD‑CAL** and **Sys‑CAL** for carriers and holons, **Decsn‑CAL** (utility), and declared must-constraint owners such as [[E_The FPF Constitution and Authoring Guides/04_05_Four Guard-Rails of FPF/00_E.05 - Four Guard-Rails of FPF|E.5]], D.1-D.5, or service-acceptance patterns.
...
| **Local truth vs. Cross‑context reuse** | Meaning is context‑local ([[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/01_A.01.01 - Bounded Model-Use Structure and DDD Bounded-Context Recovery]]); yet we need Bridges to compare across organisations/disciplines.                                         |
