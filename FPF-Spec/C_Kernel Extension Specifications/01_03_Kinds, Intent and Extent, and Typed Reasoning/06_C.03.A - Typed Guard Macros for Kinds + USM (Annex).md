...
> **One-line summary.** These guard macros combine [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/00_C.03 - Kinds, Intent and Extent, and Typed Reasoning|C.3]] declaration compatibility, the exact [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - Kind Intent, Membership Judgment, and Extension|C.3.2]] candidate judgment when an actual candidate is current, RoleMask and KindBridge declarations/relations, and [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] Scope without collapsing them. A claim quantified over a kind can be checked at declaration level; applying that claim or a capability to one candidate additionally requires `J(candidate, kind, signatureEdition, slice)`. `true`, `false`, and `unknown` remain classification values, while allow/refuse remains a separate guard disposition. KindAT never appears in a guard.
...
**Placement.** Part C (Kinds), identifier **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]**. Audience: engineering managers, editors, reviewers, assurance leads, and authors of regulatory, evidence, ESG, and Method–Work checks.

**Depends on.**

- **[[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] USM:** exact `U.ContextSlice`, Claim/Work scope, `Gamma_time`, scope bridges, and SpanUnion.
- **C.3/C.3.1:** exact local kinds and obtaining `U.SubkindOf` relations.
- **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - Kind Intent, Membership Judgment, and Extension|C.3.2]]:** `KindSignature` declaration epistemes, `J(candidate, kind, signatureEdition, slice)`, `true`/`false`/`unknown`, and optional extension representations.
- **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:** obtaining `KindBridge` relations and separate bridge-assertion epistemes carrying `CL^k`, loss, evidence, definedness, and admitted use.
- **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/04_C.03.04 - RoleMask - Contextual Adaptation of Kinds (without cloning)|C.3.4]]:** `RoleMask` and `MaskAdapter` declaration epistemes and `J_mask(candidate, kind, kindSignatureEdition, roleMaskEdition, slice)`.
- **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:** KindAT as an editorial facet forbidden in guards.
- **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/00_C.02 - Epistemic holon composition (KD-CAL)|C.2]].2/C.2.3 and Part B:** F–G–R, formality on the owning episteme, bridge consequences, and scope congruence.
- **A.15/A.15.1:** the separation of capability, plan, exact actual Work occurrence, and every episteme about it.

## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:1 - Purpose and audience
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:2 - Problem
...
[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]] restores two levels:
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:3 - Shared outcome model
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:4.1 - Guard_TypedClaim — declaration-level admission
...
2. establish declaration-level kind compatibility:
   - in one context, the kinds are identical or `SubkindOfObtains(k_receive, k_claim; effectiveReferenceScheme)` holds under [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/01_C.03.01 - U.Kind and U.SubkindOf Core|C.3.1]], with an identified `R_sub : U.SubkindOf` occurrence only when occurrence identity is needed; or
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:4.2 - Guard_CandidateUse — apply a typed claim to an exact candidate
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:4.3 - Guard_TypedJoin — compose typed producers and consumers
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:4.4 - Guard_MaskedUse — exact RoleMask use
...
1. recover the exact [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] RoleMask declaration episteme, its base kind, pinned base signature edition, intended use, candidate-feature constraints, bindings, dependencies, and definedness;
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:4.5 - Guard_SpanUnion_Typed — parallel support lines
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:4.6 - Guard_XContext_Typed — cross-context typed reuse
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:5 - Evaluation semantics and order (normative)
...
**E-03 (Three values).** Every current [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - Kind Intent, Membership Judgment, and Extension|C.3.2]] or [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/04_C.03.04 - RoleMask - Contextual Adaptation of Kinds (without cloning)|C.3.4]] classification consumed by a guard MUST retain `true`, `false`, or `unknown`. Missing evidence, unavailable declared dependency, or out-of-domain input MUST NOT be coerced to `false`.
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:6.1 - Proven-equivalent aliases
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:6.2 - Bridge consequences
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:8 - Guard anti-patterns and remedies (informative)
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:9 - Worked examples (informative)

**E1 — Same-context braking claim.** A policy quantified over `Vehicle` pins `VehicleSignature@v4`; the receiver pins `PassengerCarSignature@v3`. Declaration admission establishes `SubkindOfObtains(PassengerCar, Vehicle; plantVehicleScheme)`. Applying the policy to VIN-17 evaluates `J(VIN-17, PassengerCar, v3, S-plant)`; on `true`, [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/01_C.03.01 - U.Kind and U.SubkindOf Core|C.3.1]] monotonicity supplies the Vehicle-side consequence needed by the universal claim. A missing axle dependency yields `unknown` and a separate refusal.
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:10 - Rationale
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:Annex A - Regulatory and compliance alignment [A/I]

#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:[[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/00_A.01 - Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)|A.1]] Purpose and fit
...
**C-REG-7 (Editioning).** A change in law that changes the criterion creates another signature episteme edition; a change in applicability changes Scope. [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/01_C.03.01 - U.Kind and U.SubkindOf Core|C.3.1]] decides kind continuity. Guards SHALL pin editions and time and SHALL NOT rely on “latest”.
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:[[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/00_A.03 - Transformer Constitution (Quartet)|A.3]] Regulatory guards
...
2. Author the required signature episteme edition and let [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/01_C.03.01 - U.Kind and U.SubkindOf Core|C.3.1]] settle kind continuity.
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:[[A_Kernel Architecture Cluster/05_Open-Ended Kernel & Extension Layering/00_A.05 - Open-Ended Kernel & Extension Layering|A.5]] Guidance and migration [I]
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/00_A.06 - Signature Stack & Boundary Discipline|A.6]] Manager's compact pattern [I]
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:Annex B - Assurance lanes and evidence design [A/I]

#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:[[B_Trans-disciplinary Reasoning Cluster/00_01_Holon Aggregation and Part-Whole Construction/00_B.01 - Holon Aggregation and Part-Whole Construction|B.1]] What typed assurance adds [I]
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:[[B_Trans-disciplinary Reasoning Cluster/01_02_Meta-Holon Transition - Whole Reidentification/00_B.02 - Meta-Holon Transition - Whole Reidentification|B.2]] Normative obligations
...
**EA-8 (No scope-by-wording).** More general wording, more matching candidates, or additional evidence-matrix rows SHALL NOT widen G. A `ΔG+` change requires the new support or sufficiently congruent bridge basis required by [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]; otherwise retain or narrow the declared Scope.

#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:[[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] Evidence matrix [I]
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:[[B_Trans-disciplinary Reasoning Cluster/03_04_Canonical Evolution Loop/00_B.04 - Canonical Evolution Loop|B.4]] VA lane [A/I]
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:[[B_Trans-disciplinary Reasoning Cluster/04_05_Canonical Reasoning Cycle/00_B.05 - Canonical Reasoning Cycle|B.5]] LA lane [A/I]
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:B.6 TA lane [A/I]
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:B.7 Evidence guards
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:B.8 Anti-patterns and remedies
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:B.9 End-to-end example [I]
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:Annex C - ESG and Method–Work guards

#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:C.1 ESG obligations (normative)
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/00_C.02 - Epistemic holon composition (KD-CAL)|C.2]] Method–Work obligations (normative)

This Method–Work slice is conditional; it is not a definition that makes every actual change agentic, capability-held, planned, method-mediated, or Work. Open its capability/method/WorkPlan entry checks only when those objects and an [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]] Work use are current. A natural, spontaneous, formal, jointly caused, or non-separable `U.Transformation` remains under A.3/A.3.4 and does not acquire a fictive performer, role assignment, method, capability, plan, or Work to satisfy this guard. A broader scale-free-agency or Work decision remains with [[A_Kernel Architecture Cluster/13_The Agential Role & Agency Spectrum/00_A.13 - The Agential Role & Agency Spectrum|A.13]], C.9, and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]]; this annex neither settles nor forbids it. Reflexive cases require separately grounded acting and affected positions, while joint or non-separable cases keep their direct dynamics, interaction, or causality governors rather than forcing one arbitrary actor-target split.
...
**Actual result or acceptance.** When performed Work is current, the guard SHALL identify exact `W : U.Work` as an independently grounded, world-side, dated 4D Work occurrence under [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]]. `W` is not the `U.Work` kind, JobSlice, capability, plan item, log, card, row, or assertion. Any plan, log, result record, or assurance record about W is a separate episteme that designates W.
...
**MethodWork_ResultGate(W, JobSlice, actualInputs, actualOutputs, declarations, ResultRecordRef?).** First recover the independently grounded dated W under [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]]. Then evaluate exact input/output candidate judgments, check scope and any acceptance predicates, and keep any ResultRecordRef as a separate episteme designating W.

#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:C.4 Worked examples [I]

**ESG braking policy.** The claim pins `VehicleSignature@v4` and the dry/wet TargetSlice. The consumer is restricted to `PassengerCar`, and `SubkindOfObtains(PassengerCar, Vehicle; plantVehicleScheme)` holds under the paired exact declaration editions. For VIN-17, evaluate `J(VIN-17, PassengerCar, passengerCarEdition, TargetSlice)=true`; [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/01_C.03.01 - U.Kind and U.SubkindOf Core|C.3.1]] monotonicity then supplies the Vehicle-side classification needed by the universal claim. An unavailable brake-configuration dependency would yield `unknown`, and the transition would refuse separately.
...
#### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]:C.5 Anti-patterns and remedies
