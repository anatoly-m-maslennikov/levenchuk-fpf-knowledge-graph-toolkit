...
**Placement.** Part C (Kinds), identifier **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]**. Audience: engineering managers, architects, editors, and assurance leads.

**Depends on.**

- **C.3/C.3.1:** the context-local `U.Kind`, obtaining `U.SubkindOf` relations, and kind continuity.
- **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - Kind Intent, Membership Judgment, and Extension|C.3.2]]:** the separate `KindSignature` declaration episteme, exact four-input classification judgment, and optional pinned-edition extension representation.
- **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:** the obtaining `KindBridge` relation and its separate bridge-assertion episteme carrying `CL^k`, loss, evidence, and admitted use.
- **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/04_C.03.04 - RoleMask - Contextual Adaptation of Kinds (without cloning)|C.3.4]]:** the `RoleMask` declaration episteme and exact masked judgment.
- **[[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/03_C.02.02 - Reliability R in the F-G-R triad|C.2.2]], and [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]]:** Claim/Work scope, F–G–R, and `U.Formality` on the episteme that owns it.
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:1 - Purpose
...
- bridge and mask objects retain the ontology assigned by [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]] and [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/04_C.03.04 - RoleMask - Contextual Adaptation of Kinds (without cloning)|C.3.4]].

## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:2 - Orthogonality and rationale
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:5 - Misuse and antidotes (informative)
...
- **“A reused RoleMask has been promoted automatically.”** Wrong: if the distinction is conceptual and stable, separately identify a local kind and establish any obtaining `U.SubkindOf` relation under [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/01_C.03.01 - U.Kind and U.SubkindOf Core|C.3.1]].
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:7 - Authoring and review guidance (informative)

### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:7.1 - Fast rubric
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:7.2 - Review questions
...
- **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/00_C.03 - Kinds, Intent and Extent, and Typed Reasoning|C.3]].1/C.3.2.** KindAT may guide work on the signature declaration and assurance plan; it changes neither kind continuity nor the four-input judgment.
- **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]].** KindAT may suggest what preservation evidence to seek. The bridge assertion, not the tag, carries `CL^k`, loss, evidence, and admitted use.
- **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/04_C.03.04 - RoleMask - Contextual Adaptation of Kinds (without cloning)|C.3.4]].** Repeated mask use is a review cue only. A new local kind and any `U.SubkindOf` relation are established independently.
- **[[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]].** Scope remains G on the claim or Work use. KindAT never supplies coverage.
- **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]].** The relevant declaration or claim episteme owns F. KindAT can motivate investment but cannot assign the value.
