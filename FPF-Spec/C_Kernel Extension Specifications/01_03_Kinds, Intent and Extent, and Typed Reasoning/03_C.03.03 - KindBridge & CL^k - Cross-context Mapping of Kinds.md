...
> **One-line summary.** Defines **`KindBridge`** as the direct cross-context relation between one exact source local kind and one exact target local kind under pinned reference-scheme editions and a declared mapping predicate. A separate [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] bridge-assertion episteme states direction, paired `KindSignature` editions, order preservation or collapse, `CL^k`, loss notes, definedness, evidence, and admitted use. Target classification is always a fresh four-input [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - Kind Intent, Membership Judgment, and Extension|C.3.2]] judgment; a source result or bridge assertion never creates target truth. `CL^k` affects only the receiving reliance value R, while F and Claim scope G remain with their own owners.
...
* **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/01_C.03.01 - U.Kind and U.SubkindOf Core|C.3.1]] — U.Kind & SubkindOf (Core):** kinds are context-local `U.Kind` values; `U.SubkindOf` is an obtaining direct relation under an exact effective reference scheme; kinds carry no Scope.
* **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - Kind Intent, Membership Judgment, and Extension|C.3.2]] — Kind intent, judgment, and extension:** `KindSignature` is a declaration episteme; `J(candidate, kind, signatureEdition, slice)` returns `true`, `false`, or `unknown`; an optional pinned-edition `KindExtension` is only a representation of true candidates.
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:5 - Solution — Direct relation and bridge assertion
...
`KindBridge` is the direct relation kind governed here under the common `U.Relation` occurrence discipline of [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.REL - Relation Obtaining and Individuated Relation Occurrences|A.6.REL]]. This spelling does not by itself admit a durable dependent U-kind named `U.KindBridge`. An [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/00_F.09 - Alignment and Bridge across Contexts|F.9]] Bridge, Bridge Card, mapping row, or publication can serve as a bridge assertion or representation only when its exact content and EntityOfConcern support that use; its existence does not make a `KindBridge` relation obtain or identify an occurrence by record identity.

Keep the direct relation separate from the [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] bridge-assertion episteme used to communicate or rely on it. That episteme designates the exact bridge occurrence when occurrence identity is needed and carries the mapping rule, order-preservation status, `CL^k`, loss notes, definedness area, evidence, and admitted receiving use. An assertion, bridge card, table row, or mapping expression neither makes the bridge relation obtain nor creates a target `KindSignature`. If a target declaration is needed, author and identify that separate [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - Kind Intent, Membership Judgment, and Extension|C.3.2]] declaration episteme first.
...
A source-context judgment may support the bridge or reliance assertion but is never reused as target truth. Missing target-side evidence, an unavailable target-declaration dependency, or a candidate outside the target evaluation domain yields `unknown` for the target [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - Kind Intent, Membership Judgment, and Extension|C.3.2]] judgment. An unavailable mapping dependency or a bridge use outside declared definedness instead leaves the required bridge reliance unsettled or inadmissible; a receiving guard declines that cross-context use without rewriting an independently evaluated target judgment.
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:6.1 - Direct relation subject and scope
...
**KB-02 (No Scope).** A KindBridge MUST NOT map Claim or Work scope G. Scope translation uses the USM Bridge + CL channel ([[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]], Part B). `U.ContextSlice` values appear in bridge applicability and target judgments, not as scope stored on either kind.
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:6.2 - Settlement, assertion, and identity

**KB-03 (Direct settlement).** The [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]] direct relation settlement SHALL make recoverable:
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:7.2 - With target classification ([[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - Kind Intent, Membership Judgment, and Extension|C.3.2]])
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:8.1 - Authoring a KindBridge assertion
...
| **KB-04** | Target classification is the exact four-input [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - Kind Intent, Membership Judgment, and Extension]] judgment under fixed inputs; a source result is not target truth and `unknown` remains distinct from guard refusal. |
...
* **B-P1.** Part B (Bridges) SHALL distinguish the kind channel—reliance on an obtaining [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]] `KindBridge` direct relation plus its separate bridge assertion—from USM scope and [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/00_F.09 - Alignment and Bridge across Contexts|F.9]] sense-Bridge channels. A Bridge Card or bridge-class row does not become the `KindBridge` occurrence.
