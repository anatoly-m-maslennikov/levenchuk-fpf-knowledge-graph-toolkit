...
*Didactic anchor.* This mirrors [[C_Kernel Extension Specifications/10_22_Task Typing and TaskSignature Assignment (Problem-CHR)/00_C.22 - Task Typing and TaskSignature Assignment (Problem-CHR)|C.22]]’s typed‑signature discipline and CHR legality (no ordinal means; unit alignment for **ratio**).
