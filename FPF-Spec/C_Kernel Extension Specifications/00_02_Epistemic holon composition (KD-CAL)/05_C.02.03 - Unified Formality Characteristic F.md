...
- **Coordinates with:** [[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/02_C.19.02 - Use-Bounded Apparatus Application|C.19.2]] when a declared use asks whether increasing rigor of expression or selecting/configuring a formal apparatus repays application work. `F` measures expression rigor; it does not select the apparatus, plan the work, or establish the problem-facing result.
