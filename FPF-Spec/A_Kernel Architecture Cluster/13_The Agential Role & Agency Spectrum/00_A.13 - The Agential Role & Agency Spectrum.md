...
FPF's solution is threefold: it defines agential participation via `U.RoleAssignment` ([[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]), makes agency measurable with a dedicated Characterization, and provides a didactic summary via a graded scale.
