...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:0 - Use This When
...
- a performed-work attribution is needed: one exact dated Work occurrence `W` and one exact assignment `RA` participate in `performedUnderAssignment(W, RA)`, the direct relation governed by [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]; the actual performer is the admitted holder System `S = RA.HolderSystemSlot`, and a separate assertion may designate `W` and `RA`;
...
- Use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]] when an external relation notation labels a participant `role` and the current task is to recover its exact SlotKind and ValueKind.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:1 - Problem Frame
...
Assignment is also not performed work. A current assignment may exist before any work occurs. When work does occur, the admitted holder System `S = RA.HolderSystemSlot` performs exact Work `W` under exact assignment `RA`; [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]] owns the direct `performedUnderAssignment(W, RA)` relation. Capability, role state, method admission, responsibility, assignment decisions, and evidence remain separate relations with their own obtaining and currentness conditions.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:2 - Problem
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:3 - Forces
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:4.1 - Relation-Occurrence Identity
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:4.2 - Filling the Declared Slots
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:4.3 - Well-Formedness Predicates
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:4.4 - Demand-Driven Materialization
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:4.5 - Direct Neighboring Relations

| Current question | Direct exit | Why it stays separate |
| --- | --- | --- |
| Is the holder able to do the work? | [[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures]] capability and capability-fit relation | Assignment does not create ability. |
| Is the assignment in an enactable state now? | [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission]] role-state relation | State predicate, evidence, and state window differ from assignment identity. |
| Which method admits this role? | [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Reusable Way of Doing with Explicit Applicability]], [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/00_A.15 - Role-Method-Work Alignment]] | Method and method-description claims do not assign a holder. |
| Was work performed under the assignment? | [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work]], [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check]] | `U.Work` is a dated occurrence and has its own identity. |
...
| Does a DDD organization change this receiving interpretation? | [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/01_A.01.01 - Bounded Model-Use Structure and DDD Bounded-Context Recovery]] plus the receiving assertion or work-use pattern | The receiving episteme or use may designate the selected structure; generic `U.RoleAssignment` gains no optional participant. |
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:4.6 - Performed-Work Attribution
...
`Robot-7` is the admitted System in `RoleAssignment-17.HolderSystemSlot`. [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]] governs `InspectionWork-17`; [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]] governs `RoleAssignment-17`; [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]] owns the attribution relation. The assignment does not prove that work occurred, and the work occurrence does not alter assignment identity.
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:4.7 - Legacy Context Shorthand
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:5 - Archetypal Grounding

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:5.1 - Robot Assigned for One Inspection Shift
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:5.2 - Repeated Assignment Episodes
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:5.3 - Motor Holding a Drive Role
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:5.4 - DDD Model-Use Structure Changes a Receiving Interpretation
...
The second block belongs to the receiving assertion or work use. It does not add a fifth participant to `U.RoleAssignment` and does not change generic occurrence identity. The selected structure was independently recovered under [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/01_A.01.01 - Bounded Model-Use Structure and DDD Bounded-Context Recovery|A.1.1]]; it neither assigns the service nor performs approval work. If a future dependent relation species truly obtains only with one selected structure, its direct pattern must declare that structure as a required identity-bearing participant.

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:5.5 - Reviewer and Review Report

`ReviewService-4` holds `ReviewerRole` through `ReviewService-4-ReviewerAssignment` and, as that assignment's admitted holder System, performs `ReviewWork-82` under it through [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]] `performedUnderAssignment(ReviewWork-82, ReviewService-4-ReviewerAssignment)`. `ReviewReport-82` is a separately identified `U.Episteme`; when the work first constitutes that exact episteme and the inception claim matters, [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/07_A.15.PROD - Production Work, Entity-Identity Inception, and Production Completion Recovery|A.15.PROD]] recovers the local work/change/identity claim. Its content may state a review judgment under the direct evaluation pattern. A later evidence relation may use the report for another claim; the report never fills `HolderSystemSlot` merely because it is useful.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:6 - Bias Annotation
...
| Assignment-as-work drift | Current assignment is treated as evidence that work happened. | Name exact dated `U.Work` `W`, exact assignment `RA`, and the admitted holder System `S = RA.HolderSystemSlot`; state that `S` performed `W` under `RA` through [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check]] `performedUnderAssignment(W, RA)`. |
| Assignment-as-capability drift | Holding a role is treated as proof of ability. | Use [[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures]] and a capability-fit relation. |
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:7 - Working Guidance
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:8 - Conformance Checklist
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:9 - Common Anti-Patterns
...
| One assignment row reused for every shift | Storage identity collapses repeated relation occurrences. | Identify each assignment episode by its temporal extent under [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.REL - Relation Obtaining and Individuated Relation Occurrences]]. |
...
| Durable `RoleEnactment` kind or occurrence | A derived attribution duplicates Work and assignment. | Let [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work]] govern the exact Work occurrence and [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check]] alone govern `performedUnderAssignment(W, RA)`; do not create another enactment kind or occurrence. |
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:10 - Consequences
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:11 - Rationale
...
The assignment is a relation occurrence, not a relation value stored in a row. Its participant meanings and temporal episode provide the domain identity required by [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.REL - Relation Obtaining and Individuated Relation Occurrences|A.6.REL]]. This prevents two opposite errors: treating every role label as a complete assignment, and requiring explicit assignment-occurrence individuation for casual recognition text.
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:12 - SoTA-Echoing
...
| FPF relation-occurrence discipline separates predicate obtaining, assertion, explicit individuation, identifier assignment, and reference use. | Current [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.REL - Relation Obtaining and Individuated Relation Occurrences]] line. | Materialize a role-assignment occurrence only when another claim needs its identity; use temporal extent to distinguish repeated episodes. | A staffing sentence stays readable, while a work-attribution claim can reference the exact shift assignment. |

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:13 - Relations

**Builds on:** [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]] for `U.Role`; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.REL - Relation Obtaining and Individuated Relation Occurrences|A.6.REL]] for relation obtaining and occurrence identity; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]] for SlotSpec discipline; [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme- Constitution, Empirical Grounding, and Edition Relations|C.2.1]] for the role-taxonomy episteme and effective reference scheme.

**Coordinates with:** [[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures|A.2.2]] for capability; [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission|A.2.5]] for role state; [[A_Kernel Architecture Cluster/02_Role Taxonomy/07_A.02.07 - RoleRelationStructure@BoundedContext - Context-Local Role Relations and Representation-Lens Boundary|A.2.7]] for selected role relation structure; [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Reusable Way of Doing with Explicit Applicability|A.3.1]], [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/00_A.15 - Role-Method-Work Alignment|A.15]] for method admission; [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/01_A.15.01 - U.Work|A.15.1]] and [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]] for performed-work attribution.

**Uses when current:** [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/01_A.01.01 - Bounded Model-Use Structure and DDD Bounded-Context Recovery|A.1.1]] for an optional selected model-use structure; [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/00_F.09 - Alignment and Bridge across Contexts|F.9]] and [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/19_A.06.09 - Cross-Context Sameness Disambiguation - Repairing cross-context -same-, -equivalent-, and -align- via explicit Bridges (RPR-XCTX)|A.6.9]] for cross-scheme alignment; direct responsibility, decision, evidence, reliance, provenance, currentness, and publication patterns for claims about the assignment occurrence.
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]]:End
