...
- If the current claim is the assignment relation linking holder, role, context, and window, use [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]].
...
- If the current claim is method, method description, work plan, or performed work alignment, use [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/00_A.15 - Role-Method-Work Alignment|A.15]].
...
- If the current issue is only a confusing role-like word, first use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/12_A.06.RSIR - Relation, Signature, Interface, Role, and Slot Precision Restoration|A.6.RSIR]] to recover the governed object or claim kind.
...
7. **Argument-position drift appears.** "Role" is used for relation argument positions or slot positions, competing with [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]] SlotSpec discipline.
...
The normative assignment relation is governed by [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]], not by the notation. Its core slots are:
...
| "the role of this relation argument" | SlotKind or relation position under [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline]], not `U.Role`. |

If the direct kind is not yet clear, use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/12_A.06.RSIR - Relation, Signature, Interface, Role, and Slot Precision Restoration|A.6.RSIR]].
...
- use [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]] when holder, role value, context, window, assignment source, or work-role qualifier is current;
...
- use [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/00_A.15 - Role-Method-Work Alignment|A.15]] when method, method description, work plan, or performed work is current;
...
- use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]] when the word "role" is only a relation position or SlotKind.
...
3. If the phrase names the holder-role-context-window relation, recover `U.RoleAssignment` under [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - System Role Assignment|A.2.1]].
...
6. If the phrase names performed work, intended work, or governing method, use [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment/00_A.15 - Role-Method-Work Alignment|A.15]] and its neighboring method and work patterns.
...
8. If the phrase only names a relation position, field, parameter, or argument, use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]].
...
| CC-A2.9 | Relation argument positions and SlotKinds are governed by [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline]]; they do not become `U.Role`. |
...
| "Argument role equals U.Role" | A relation position is not an enactment-facing role value. | Use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline]] SlotKind and relation signature discipline. |
