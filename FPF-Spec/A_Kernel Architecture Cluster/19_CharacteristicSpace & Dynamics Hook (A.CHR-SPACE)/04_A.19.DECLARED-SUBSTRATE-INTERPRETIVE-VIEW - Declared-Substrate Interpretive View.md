...
- the line would change the EntityOfConcern rather than preserve it; use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/09_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] or the appropriate retargeting pattern.
...
- Use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/10_P_Relational Precision Restoration - Recovering Direct Relations from Under-Specified Claims/00_A.06.P - Relational Precision Restoration - Recovering Direct Relations from Under-Specified Claims|A.6.P]] when one passage collapses view, surface, space, map, or palette into one umbrella word. Repair the layer split first, then continue.
