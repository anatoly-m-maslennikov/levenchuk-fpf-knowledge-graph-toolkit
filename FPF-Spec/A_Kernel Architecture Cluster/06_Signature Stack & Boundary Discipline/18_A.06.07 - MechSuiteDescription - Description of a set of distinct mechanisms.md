...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:2 - Problem
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:3 - Forces
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:4 - Solution

Introduce a new Kernel description token:

### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:4.1 `MechSuiteDescription` (data model)
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:4.2 SuiteObligations (canonical obligation vocabulary)
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:4.3 SuiteSpecPins
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:4.4 SuiteProtocols
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:4.5 SuiteAuditObligations
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:4.6 Examples (tell–show–show discipline)
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:5 - Archetypal Grounding
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:6 - Bias-Annotation
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:7 - Conformance Checklist

A `MechSuiteDescription` is conformant iff all applicable items hold:

**CC‑[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]‑1 (Correct level).** The suite’s `mechanisms` enumerate **distinct** `U.Mechanism.Intension` members. The suite is not encoded as `MechFamilyDescription`.

**CC‑[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]‑2 (Description token, not `U.*`).** The suite token is a Description token and MUST NOT be introduced under `U.*`. Its name ends with `…Description`.

**CC‑[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]‑3 (No execution semantics).** The suite MUST NOT define mechanism blocks (`OperationAlgebra`, `LawSet`, etc.) and MUST NOT be used as a mechanism node.

**CC‑[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]‑4 (No gate decisions).** The suite MUST NOT define `GateDecision`, MUST NOT publish `DecisionLog`, and MUST preserve gate/mechanism separation.
...
**CC‑[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]‑10 (Suite id present).** The suite MUST declare `mech_suite_id: MechSuiteId` so that downstream planning/audit can cite it stably.
...
**CC‑[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]‑13 (No Pack conflation).** The suite MUST NOT be introduced, named, or used as a publication/shipping `Pack`.
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:9 - Consequences
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:10 - Rationale
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:11 - SoTA-Echoing
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:12 - Relations

* **Relates to [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/06_A.06.01 - U.Mechanism - Reusable Law-Governed Operation Declaration|A.6.1]]:** suite members are `U.Mechanism.Intension`; the suite does not replace the mechanism definition.
* **Relates to [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]]:** suites must not weaken slot/ref discipline; any suite protocol assumes member mechanisms follow [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.05 - Relation-Declaration Slot Discipline - SlotKind, ValueKind, RefKind, and participant-designation discipline|A.6.5]] invariants (SlotKind stability, correct refMode, no semantic meaning in SlotIndex).
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/18_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:End
